...
@Client.on_message(filters.command("ai", "gpt1") & filters.chat(SUPPORT_CHAT_ID)) # support work only added 
async def ai_generate(client, message):
   user_input = message.text.split()[1:]

   if not user_input:
       await message.reply_text("command incomplete provide /ai /gpt1 hello")
       return
