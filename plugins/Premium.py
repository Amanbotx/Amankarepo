...
async def plan(client, message):
    ...
    btn = [[
        ...
        InlineKeyboardButton('ᴄʟɪᴄᴋ ᴛᴏ ʜᴇʀᴇ', callback_data='aman')],[InlineKeyboardButton("❌ ᴄʟᴏꜱᴇ ❌", callback_data="close_data")
    ]]
    await message.reply_photo(photo="https://telegra.ph/file/734170f40b8169830d821.jpg", caption=script.PLAN_TEXT.format(message.from_user.mention), reply_markup=InlineKeyboardMarkup(btn))
